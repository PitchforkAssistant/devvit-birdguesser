...
export type GameImageProps = RoundedImageProps & Devvit.Blocks.TextProps & Devvit.Blocks.StackProps & Devvit.Blocks.HasStringChildren;
...
export const GameImage = (props: GameImageProps) => (
    <zstack alignment="center middle" height={props.imageHeight} width={props.imageWidth}>
        ...
        <vstack height={props.imageHeight} alignment="end bottom" padding="none" width="100%">
            <hstack padding="none" alignment="end bottom" width="110%">
                <spacer grow/>
                {props.children ? (
