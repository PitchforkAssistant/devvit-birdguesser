...
**/
export type UseAsyncStateResult<T extends JSONValue> = {
    data: T | null;
...
/**
 * Options for the useAsyncState function.
 ...
 */
export type UseAsyncStateOptions<T extends JSONValue> = {
    depends?: JSONValue[];
 ...
 * @returns {UseAsyncStateOptions<T>} The data, loading state, error, and a setData function.
 */
export function useAsyncState <T extends JSONValue> (initializer: UseAsyncStateInitializer<T | null>, options?: UseAsyncStateOptions<T>): UseAsyncStateResult<T> {
